 ...
 *	$Id: mbr_omghdcsj.c 2308 2017-06-04 19:55:48Z caress $
 *
...
static char rcs_id[] = "$Id: mbr_omghdcsj.c 2308 2017-06-04 19:55:48Z caress $";
...
int mbr_info_omghdcsj(int verbose, int *system, int *beams_bath_max, int *beams_amp_max, int *pixels_ss_max, char *format_name,
	...
	*pixels_ss_max = 1024;
	...
	strncpy(format_description,
	        "Format name:          MBF_OMGHDCSJ\nInformal Description: UNB OMG HDCS format (the John Hughes Clarke "
...
int mbr_rt_omghdcsj(int verbose, void *mbio_ptr, void *store_ptr, int *error) {
	...
	if ((read_size = fread(buffer, 1, 4, mb_io_ptr->mbfp)) == 4) {
		...
		else if (buffer[0] == 'H' && buffer[1] == 'D' && buffer[2] == 'C' && buffer[3] == 'S') {
	...
	/* read summary */
	if (status == MB_SUCCESS && dataplus->kind == MB_DATA_SUMMARY) {
		if ((read_size = fread(&buffer[4], 1, MBF_OMGHDCSJ_SUMMARY_SIZE - 4, mb_io_ptr->mbfp)) != MBF_OMGHDCSJ_SUMMARY_SIZE - 4) {
			status = MB_FAILURE;
			*error = MB_ERROR_EOF;
		}
		/* parse the summary data */
			...
			summary->sensorNumber = mb_swap_int(*int_ptr);
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->subFileID = mb_swap_int(*int_ptr);
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->fileVersion = mb_swap_int(*int_ptr);
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->toolType = mb_swap_int(*int_ptr);
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->numProfiles = mb_swap_int(*int_ptr);
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->numDepths = mb_swap_int(*int_ptr);
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->timeScale = mb_swap_int(*int_ptr);
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->refTime = mb_swap_int(*int_ptr);
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->minTime = mb_swap_int(*int_ptr);
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->maxTime = mb_swap_int(*int_ptr);
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->positionType = mb_swap_int(*int_ptr);
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->positionScale = mb_swap_int(*int_ptr);
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->refLat = mb_swap_int(*int_ptr);
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->minLat = mb_swap_int(*int_ptr);
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->maxLat = mb_swap_int(*int_ptr);
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->refLong = mb_swap_int(*int_ptr);
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->minLong = mb_swap_int(*int_ptr);
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->maxLong = mb_swap_int(*int_ptr);
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->minObsDepth = mb_swap_int(*int_ptr);
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->maxObsDepth = mb_swap_int(*int_ptr);
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->minProcDepth = mb_swap_int(*int_ptr);
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->maxProcDepth = mb_swap_int(*int_ptr);
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->status = *int_ptr;
#else
			int_ptr = (int *)&buffer[offset];
			summary->sensorNumber = *int_ptr;
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->subFileID = *int_ptr;
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->fileVersion = *int_ptr;
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->toolType = *int_ptr;
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->numProfiles = *int_ptr;
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->numDepths = *int_ptr;
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->timeScale = *int_ptr;
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->refTime = *int_ptr;
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->minTime = *int_ptr;
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->maxTime = *int_ptr;
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->positionType = *int_ptr;
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->positionScale = *int_ptr;
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->refLat = *int_ptr;
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->minLat = *int_ptr;
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->maxLat = *int_ptr;
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->refLong = *int_ptr;
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->minLong = *int_ptr;
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->maxLong = *int_ptr;
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->minObsDepth = *int_ptr;
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->maxObsDepth = *int_ptr;
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->minProcDepth = *int_ptr;
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->maxProcDepth = *int_ptr;
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			summary->status = *int_ptr;
#endif
			...
			if (summary->fileVersion == 4) {
				if ((read_size = fread(&buffer[MBF_OMGHDCSJ_SUMMARY_SIZE], 1, MBF_OMGHDCSJ_SUMMARY_V4EXTRA_SIZE,
				                       mb_io_ptr->mbfp)) != MBF_OMGHDCSJ_SUMMARY_V4EXTRA_SIZE) {
					status = MB_FAILURE;
					*error = MB_ERROR_EOF;
				}
				else {
					...
					for (i = 0; i < 20; i++) {
						...
						*/
						int_ptr = (int *)&buffer[offset];
						summary->Beam_BitsDefining[i] = mb_swap_int(*int_ptr);
						offset += 4;
					}
#else
					int_ptr = (int *)&buffer[offset];
			...
			*toolType = summary->toolType;
			...
			if (status == MB_SUCCESS) {
				...
				if (data->beams != NULL)
					status = mb_freed(verbose, __FILE__, __LINE__, (void **)&data->beams, error);
				if (status == MB_SUCCESS)
					status = mb_mallocd(verbose, __FILE__, __LINE__, *num_beam * sizeof(struct mbf_omghdcsj_beam_struct),
	...
	/* or read comment */
	else if (status == MB_SUCCESS && dataplus->kind == MB_DATA_COMMENT) {
		if ((read_size = fread(dataplus->comment, 1, MBF_OMGHDCSJ_MAX_COMMENT, mb_io_ptr->mbfp)) != MBF_OMGHDCSJ_MAX_COMMENT) {
			status = MB_FAILURE;
			*error = MB_ERROR_EOF;
		}
		else
	...
	/* or read data record */
	else if (status == MB_SUCCESS && dataplus->kind == MB_DATA_DATA) {
		/* read profile */
		if ((read_size = fread(&buffer[4], 1, *profile_size - 4, mb_io_ptr->mbfp)) != *profile_size - 4) {
			status = MB_FAILURE;
			*error = MB_ERROR_EOF;
		}
		else
		...
		if (status == MB_SUCCESS) {
			...
			if (*fileVersion == 1) {
#ifdef BYTESWAPPED
				int_ptr = (int *)&buffer[offset];
				profile->status = mb_swap_int(*int_ptr);
				offset += 4;
				int_ptr = (int *)&buffer[offset];
				profile->numDepths = mb_swap_int(*int_ptr);
				offset += 4;
				int_ptr = (int *)&buffer[offset];
				profile->timeOffset = mb_swap_int(*int_ptr);
				offset += 4;
				int_ptr = (int *)&buffer[offset];
				profile->vesselLatOffset = mb_swap_int(*int_ptr);
				offset += 4;
				int_ptr = (int *)&buffer[offset];
				profile->vesselLongOffset = mb_swap_int(*int_ptr);
				offset += 4;
				int_ptr = (int *)&buffer[offset];
				profile->vesselHeading = mb_swap_int(*int_ptr);
				offset += 4;
				int_ptr = (int *)&buffer[offset];
				if (offset < *profile_size) {
					profile->vesselHeave = mb_swap_int(*int_ptr);
					offset += 4;
					int_ptr = (int *)&buffer[offset];
					profile->vesselPitch = mb_swap_int(*int_ptr);
					offset += 4;
					int_ptr = (int *)&buffer[offset];
					profile->vesselRoll = mb_swap_int(*int_ptr);
					offset += 4;
					int_ptr = (int *)&buffer[offset];
					profile->tide = mb_swap_int(*int_ptr);
					offset += 4;
					int_ptr = (int *)&buffer[offset];
					profile->vesselVelocity = mb_swap_int(*int_ptr);
					offset += 4;
				}
				if (offset < *profile_size) {
					profile->power = buffer[offset];
					offset += 1;
					profile->TVG = buffer[offset];
					offset += 1;
					profile->attenuation = buffer[offset];
					offset += 1;
					profile->edflag = buffer[offset];
					offset += 1;
					int_ptr = (int *)&buffer[offset];
					profile->soundVelocity = mb_swap_int(*int_ptr);
					offset += 4;
					int_ptr = (int *)&buffer[offset];
					profile->lengthImageDataField = mb_swap_int(*int_ptr);
					offset += 4;
					int_ptr = (int *)&buffer[offset];
					profile->pingNo = mb_swap_int(*int_ptr);
					offset += 4;
					profile->mode = buffer[offset];
					offset += 1;
					profile->Q_factor = buffer[offset];
					offset += 1;
					profile->pulseLength = buffer[offset];
					offset += 1;
					profile->unassigned = buffer[offset];
					offset += 1;
				}
#else
				int_ptr = (int *)&buffer[offset];
				profile->status = *int_ptr;
				offset += 4;
				int_ptr = (int *)&buffer[offset];
				profile->numDepths = *int_ptr;
				offset += 4;
				int_ptr = (int *)&buffer[offset];
				profile->timeOffset = *int_ptr;
				offset += 4;
				int_ptr = (int *)&buffer[offset];
				profile->vesselLatOffset = *int_ptr;
				offset += 4;
				int_ptr = (int *)&buffer[offset];
				profile->vesselLongOffset = *int_ptr;
				offset += 4;
				int_ptr = (int *)&buffer[offset];
				profile->vesselHeading = *int_ptr;
				offset += 4;
				if (offset < *profile_size) {
					int_ptr = (int *)&buffer[offset];
					profile->vesselHeave = *int_ptr;
					offset += 4;
					int_ptr = (int *)&buffer[offset];
					profile->vesselPitch = *int_ptr;
					offset += 4;
					int_ptr = (int *)&buffer[offset];
					profile->vesselRoll = *int_ptr;
					offset += 4;
					int_ptr = (int *)&buffer[offset];
					profile->tide = *int_ptr;
					offset += 4;
					int_ptr = (int *)&buffer[offset];
					profile->vesselVelocity = *int_ptr;
					offset += 4;
				}
				if (offset < *profile_size) {
					profile->power = buffer[offset];
					...
					offset += 1;
					int_ptr = (int *)&buffer[offset];
					profile->soundVelocity = *int_ptr;
					offset += 4;
					int_ptr = (int *)&buffer[offset];
					profile->lengthImageDataField = *int_ptr;
					offset += 4;
					int_ptr = (int *)&buffer[offset];
					profile->pingNo = *int_ptr;
					offset += 4;
					profile->mode = buffer[offset];
					offset += 1;
					profile->Q_factor = buffer[offset];
				...
				profile->vesselHeading = 10000 * ((short)mb_swap_short(*short_ptr));
				offset += 2;
				short_ptr = (short *)&buffer[offset];
				profile->vesselHeave = (short)mb_swap_short(*short_ptr);
				offset += 2;
				short_ptr = (short *)&buffer[offset];
				profile->vesselPitch = 1000 * ((short)mb_swap_short(*short_ptr));
				offset += 2;
				short_ptr = (short *)&buffer[offset];
				profile->vesselRoll = 1000 * ((short)mb_swap_short(*short_ptr));
				offset += 2;
				short_ptr = (short *)&buffer[offset];
				profile->tide = (short)mb_swap_short(*short_ptr);
				offset += 2;
				short_ptr = (short *)&buffer[offset];
				profile->numDepths = (short)mb_swap_short(*short_ptr);
				offset += 2;
				profile->power = buffer[offset];
				offset += 1;
				profile->TVG = buffer[offset];
				...
				offset += 4;
				short_ptr = (short *)&buffer[offset];
				profile->vesselHeading = 10000 * (*short_ptr);
				offset += 2;
				short_ptr = (short *)&buffer[offset];
				profile->vesselHeave = *short_ptr;
				offset += 2;
				short_ptr = (short *)&buffer[offset];
				profile->vesselPitch = 1000 * (*short_ptr);
				offset += 2;
				short_ptr = (short *)&buffer[offset];
				profile->vesselRoll = 1000 * (*short_ptr);
				offset += 2;
				short_ptr = (short *)&buffer[offset];
				profile->tide = *short_ptr;
				offset += 2;
				short_ptr = (short *)&buffer[offset];
				profile->numDepths = *short_ptr;
				offset += 2;
				profile->power = buffer[offset];
				offset += 1;
				profile->TVG = buffer[offset];
				...
				if (offset < *profile_size) {
					short_ptr = (short *)&buffer[offset];
					profile->td_sound_speed = (short)mb_swap_short(*short_ptr);
					offset += 2;
					short_ptr = (short *)&buffer[offset];
					profile->samp_rate = (short)mb_swap_short(*short_ptr);
					offset += 2;
					profile->z_res_cm = buffer[offset];
					offset += 1;
					profile->xy_res_cm = buffer[offset];
					offset += 1;
					profile->ssp_source = buffer[offset];
					offset += 1;
					profile->filter_ID = buffer[offset];
					offset += 1;
					short_ptr = (short *)&buffer[offset];
					profile->absorp_coeff = (short)mb_swap_short(*short_ptr);
					offset += 2;
					short_ptr = (short *)&buffer[offset];
					profile->tx_pulse_len = (short)mb_swap_short(*short_ptr);
					offset += 2;
					short_ptr = (short *)&buffer[offset];
					profile->tx_beam_width = (short)mb_swap_short(*short_ptr);
					offset += 2;
					short_ptr = (short *)&buffer[offset];
					profile->max_swath_width = (short)mb_swap_short(*short_ptr);
					offset += 2;
					profile->tx_power_reduction = buffer[offset];
					offset += 1;
					profile->rx_beam_width = buffer[offset];
					offset += 1;
					profile->rx_bandwidth = buffer[offset];
					offset += 1;
					profile->rx_gain_reduction = buffer[offset];
					offset += 1;
					profile->tvg_crossover = buffer[offset];
					offset += 1;
					profile->beam_spacing = buffer[offset];
					offset += 1;
					profile->coverage_sector = buffer[offset];
					offset += 1;
					profile->yaw_stab_mode = buffer[offset];
					offset += 1;
				}
#else
				int_ptr = (int *)&buffer[offset];
				...
				if (offset < *profile_size) {
					short_ptr = (short *)&buffer[offset];
					profile->td_sound_speed = *short_ptr;
					offset += 2;
					short_ptr = (short *)&buffer[offset];
					profile->samp_rate = *short_ptr;
					offset += 2;
					profile->z_res_cm = buffer[offset];
					offset += 1;
					profile->xy_res_cm = buffer[offset];
					...
					offset += 1;
					short_ptr = (short *)&buffer[offset];
					profile->absorp_coeff = *short_ptr;
					offset += 2;
					short_ptr = (short *)&buffer[offset];
					profile->tx_pulse_len = *short_ptr;
					offset += 2;
					short_ptr = (short *)&buffer[offset];
					profile->tx_beam_width = *short_ptr;
					offset += 2;
					short_ptr = (short *)&buffer[offset];
					profile->max_swath_width = *short_ptr;
					offset += 2;
					profile->tx_power_reduction = buffer[offset];
					offset += 1;
					profile->rx_beam_width = buffer[offset];
				...
				if (summary->Profile_BitsDefining[0]) {
					...
					if (summary->Profile_BitsDefining[0] & PROF_ui_vesselHeading) {
						short_ptr = (short *)&buffer[offset];
						profile->vesselHeading = (int)((short)mb_swap_short(*short_ptr) * 1000);
						offset += 2;
					}
					...
					if (summary->Profile_BitsDefining[0] & PROF_si_vesselPitch) {
						short_ptr = (short *)&buffer[offset];
						profile->vesselPitch = (int)((short)mb_swap_short(*short_ptr) * 1000);
						offset += 2;
					}
					if (summary->Profile_BitsDefining[0] & PROF_si_vesselRoll) {
						short_ptr = (short *)&buffer[offset];
						profile->vesselRoll = (int)((short)mb_swap_short(*short_ptr) * 1000);
						offset += 2;
					}
				...
				if (summary->Profile_BitsDefining[1]) {
					...
					if (summary->Profile_BitsDefining[1] & PROF_ui_soundVelocity) {
						short_ptr = (short *)&buffer[offset];
						profile->soundVelocity = (short)mb_swap_short(*short_ptr);
						offset += 2;
					}
					if (summary->Profile_BitsDefining[1] & PROF_ui_lengthImageDataField) {
						short_ptr = (short *)&buffer[offset];
						profile->lengthImageDataField = (short)mb_swap_short(*short_ptr);
						offset += 2;
					}
					if (summary->Profile_BitsDefining[1] & PROF_ui_pingNo) {
						short_ptr = (short *)&buffer[offset];
						profile->pingNo = (short)mb_swap_short(*short_ptr);
						offset += 2;
					}
				...
				if (summary->Profile_BitsDefining[3]) {
					...
					if (summary->Profile_BitsDefining[3] & PROF_us_range_to_normal_incidence) {
						short_ptr = (short *)&buffer[offset];
				...
				if (summary->Profile_BitsDefining[0]) {
					...
					if (summary->Profile_BitsDefining[0] & PROF_ui_vesselHeading) {
						short_ptr = (short *)&buffer[offset];
						profile->vesselHeading = (int)(*short_ptr * 1000);
						offset += 2;
					}
					if (summary->Profile_BitsDefining[0] & PROF_si_vesselHeave) {
						short_ptr = (short *)&buffer[offset];
					...
					if (summary->Profile_BitsDefining[0] & PROF_si_vesselPitch) {
						short_ptr = (short *)&buffer[offset];
						profile->vesselPitch = (int)(*short_ptr * 1000);
						offset += 2;
					}
					if (summary->Profile_BitsDefining[0] & PROF_si_vesselRoll) {
						short_ptr = (short *)&buffer[offset];
						profile->vesselRoll = (int)(*short_ptr * 1000);
						offset += 2;
					}
					if (summary->Profile_BitsDefining[0] & PROF_si_tide) {
						int_ptr = (int *)&buffer[offset];
				...
				if (summary->Profile_BitsDefining[1]) {
					...
					if (summary->Profile_BitsDefining[1] & PROF_ui_soundVelocity) {
						short_ptr = (short *)&buffer[offset];
						profile->soundVelocity = *short_ptr;
						offset += 2;
					}
					if (summary->Profile_BitsDefining[1] & PROF_ui_lengthImageDataField) {
						short_ptr = (short *)&buffer[offset];
						profile->lengthImageDataField = *short_ptr;
						offset += 2;
					}
					if (summary->Profile_BitsDefining[1] & PROF_ui_pingNo) {
						short_ptr = (short *)&buffer[offset];
						profile->pingNo = *short_ptr;
						offset += 2;
					}
					if (summary->Profile_BitsDefining[1] & PROF_uc_mode) {
						profile->mode = buffer[offset];
		...
		/* now read next data */
		if (status == MB_SUCCESS) {
			if ((read_size = fread(buffer, 1, *data_size, mb_io_ptr->mbfp)) != *data_size) {
				status = MB_FAILURE;
				*error = MB_ERROR_EOF;
			}
			else
		...
		if (status == MB_SUCCESS) {
			...
			for (i = 0; i < profile->numDepths; i++) {
				...
				if (*fileVersion == 1) {
#ifdef BYTESWAPPED
					int_ptr = (int *)&buffer[offset];
					beam->status = mb_swap_int(*int_ptr);
					offset += 4;
					int_ptr = (int *)&buffer[offset];
					beam->observedDepth = mb_swap_int(*int_ptr);
					offset += 4;
					if ((offset - offset_start) < *beam_size) {
						int_ptr = (int *)&buffer[offset];
						beam->acrossTrack = mb_swap_int(*int_ptr);
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						beam->alongTrack = mb_swap_int(*int_ptr);
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						beam->latOffset = mb_swap_int(*int_ptr);
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						beam->longOffset = mb_swap_int(*int_ptr);
						offset += 4;
					}
					if ((offset - offset_start) < *beam_size) {
						int_ptr = (int *)&buffer[offset];
						beam->processedDepth = mb_swap_int(*int_ptr);
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						beam->timeOffset = mb_swap_int(*int_ptr);
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						beam->depthAccuracy = mb_swap_int(*int_ptr);
						offset += 4;
					}
					if ((offset - offset_start) < *beam_size) {
					...
					if ((offset - offset_start) < *beam_size) {
						int_ptr = (int *)&buffer[offset];
						beam->range = mb_swap_int(*int_ptr);
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						beam->no_samples = mb_swap_int(*int_ptr);
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						beam->offset = mb_swap_int(*int_ptr);
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						beam->centre_no = mb_swap_int(*int_ptr);
						offset += 4;
					...
					offset += 4;
					int_ptr = (int *)&buffer[offset];
					beam->observedDepth = *int_ptr;
					offset += 4;
					if ((offset - offset_start) < *beam_size) {
						int_ptr = (int *)&buffer[offset];
						beam->acrossTrack = *int_ptr;
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						beam->alongTrack = *int_ptr;
						offset += 4;
						int_ptr = (int *)&buffer[offset];
					...
					if ((offset - offset_start) < *beam_size) {
						int_ptr = (int *)&buffer[offset];
						beam->processedDepth = *int_ptr;
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						beam->timeOffset = *int_ptr;
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						beam->depthAccuracy = *int_ptr;
						offset += 4;
					}
					if ((offset - offset_start) < *beam_size) {
						beam->reflectivity = buffer[offset];
					...
					if ((offset - offset_start) < *beam_size) {
						...
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						beam->no_samples = *int_ptr;
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						beam->offset = *int_ptr;
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						beam->centre_no = *int_ptr;
						offset += 4;
						beam->sample_unit = buffer[offset];
						offset += 1;
						beam->sample_interval = buffer[offset];
					...
					if ((offset - offset_start) < *beam_size) {
						short_ptr = (short *)&buffer[offset];
						beam->observedDepth = (short)mb_swap_short(*short_ptr);
						offset += 2;
						short_ptr = (short *)&buffer[offset];
						beam->acrossTrack = (short)mb_swap_short(*short_ptr);
						offset += 2;
						beam->status = buffer[offset];
						offset += 1;
					}
					if ((offset - offset_start) < *beam_size) {
						beam->reflectivity = buffer[offset];
					...
					if ((offset - offset_start) < *beam_size) {
						short_ptr = (short *)&buffer[offset];
						beam->alongTrack = (short)mb_swap_short(*short_ptr);
						offset += 2;
					}
					if ((offset - offset_start) < *beam_size) {
						short_ptr = (short *)&buffer[offset];
						beam->range = (short)mb_swap_short(*short_ptr);
						offset += 2;
					}
					if ((offset - offset_start) < *beam_size) {
						int_ptr = (int *)&buffer[offset];
						...
						offset += 4;
						short_ptr = (short *)&buffer[offset];
						beam->no_samples = (short)mb_swap_short(*short_ptr);
						offset += 2;
						short_ptr = (short *)&buffer[offset];
						beam->centre_no = (short)mb_swap_short(*short_ptr);
						offset += 2;
					}
#else
					if ((offset - offset_start) < *beam_size) {
					...
					if ((offset - offset_start) < *beam_size) {
						short_ptr = (short *)&buffer[offset];
						beam->beam_depress_angle = (short)mb_swap_short(*short_ptr);
						offset += 2;
						short_ptr = (short *)&buffer[offset];
						beam->beam_heading_angle = (short)mb_swap_short(*short_ptr);
						offset += 2;
						beam->samp_win_length = buffer[offset];
						offset += 1;
						scaling_factor = buffer[offset];
						offset += 1;
						beam->Q_factor = buffer[offset];
						offset += 1;
						offset += 1;
				...
				/* V4 */
					...
					if (summary->Beam_BitsDefining[0]) {
						...
						if (summary->Beam_BitsDefining[0] & BEAM_uc_scaling_factor) {
							beam->scaling_factor = buffer[offset];
							offset += 1;
						}
					...
					if (summary->Beam_BitsDefining[3]) {
						...
						if (summary->Beam_BitsDefining[3] & BEAM_us_other_range) {
							short_ptr = (short *)&buffer[offset];
							beam->other_range = (short)mb_swap_short(*short_ptr);
							offset += 2;
						}
						if (summary->Beam_BitsDefining[3] & BEAM_ss_Tx_steer) {
							short_ptr = (short *)&buffer[offset];
							beam->Tx_steer = (short)mb_swap_short(*short_ptr);
							offset += 2;
						}
						if (summary->Beam_BitsDefining[3] & BEAM_ss_Rc_steer) {
							short_ptr = (short *)&buffer[offset];
							beam->Rc_steer = (short)mb_swap_short(*short_ptr);
							offset += 2;
						}
					...
					if (summary->Beam_BitsDefining[4]) {
						if (summary->Beam_BitsDefining[4] & BEAM_ui_timestampOffset) {
							int_ptr = (int *)&buffer[offset];
							beam->timestampOffset = mb_swap_int(*int_ptr);
							offset += 4;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_us_no_RAMAN) {
							short_ptr = (short *)&buffer[offset];
							beam->no_RAMAN = (short)mb_swap_short(*short_ptr);
							offset += 2;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_us_no_IR) {
							short_ptr = (short *)&buffer[offset];
							beam->no_IR = (short)mb_swap_short(*short_ptr);
							offset += 2;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_us_no_GAPD) {
							short_ptr = (short *)&buffer[offset];
							beam->no_GAPD = (short)mb_swap_short(*short_ptr);
							offset += 2;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_us_no_PMT) {
							short_ptr = (short *)&buffer[offset];
							beam->no_PMT = (short)mb_swap_short(*short_ptr);
							offset += 2;
						}
					...
					if (summary->Beam_BitsDefining[5]) {
						...
						if (summary->Beam_BitsDefining[5] & BEAM_ui_snippet_first_sample) {
							int_ptr = (int *)&buffer[offset];
							beam->snippet_first_sample = mb_swap_int(*int_ptr);
							offset += 4;
						}
						if (summary->Beam_BitsDefining[5] & BEAM_ui_snippet_last_sample) {
							int_ptr = (int *)&buffer[offset];
							beam->snippet_last_sample = mb_swap_int(*int_ptr);
							offset += 4;
						}
		...
		if (status == MB_SUCCESS && mb_io_ptr->mbfp2 != NULL &&
		    (summary->toolType == MBSYS_HDCS_EM1000 || summary->toolType == MBSYS_HDCS_EM12_single ||
		     summary->toolType == MBSYS_HDCS_EM12_dual || summary->toolType == MBSYS_HDCS_EM300 ||
		     summary->toolType == MBSYS_HDCS_EM3000 || summary->toolType == MBSYS_HDCS_EM3000D ||
		     summary->toolType == MBSYS_HDCS_EM121A || summary->toolType == MBSYS_HDCS_EM1002 ||
		     summary->toolType == MBSYS_HDCS_EM120 || summary->toolType == MBSYS_HDCS_EM122 ||
		     summary->toolType == MBSYS_HDCS_EM302 || summary->toolType == MBSYS_HDCS_SeaBat_8125 ||
		     summary->toolType == MBSYS_HDCS_SeaBat_8111 || summary->toolType == MBSYS_HDCS_SeaBat_8150 ||
		     summary->toolType == MBSYS_HDCS_EM3002 || summary->toolType == MBSYS_HDCS_EM710 ||
		     summary->toolType == MBSYS_HDCS_EM3002 || summary->toolType == MBSYS_HDCS_EM3002D ||
			...
			if (*image_size < nrawpixels || data->ss_raw == NULL) {
				*image_size = nrawpixels;
				if (data->ss_raw != NULL)
					status = mb_freed(verbose, __FILE__, __LINE__, (void **)&data->ss_raw, error);
				status = mb_mallocd(verbose, __FILE__, __LINE__, *image_size, (void **)&data->ss_raw, error);
			}
			...
			if (status == MB_SUCCESS) {
				...
				if ((read_size = fread(data->ss_raw, 1, nrawpixels, mb_io_ptr->mbfp2)) != nrawpixels) {
					if (verbose > 0)
	...
	if (status == MB_SUCCESS && dataplus->kind == MB_DATA_DATA) {
		...
		if (profile->numSamples <= 0 || profile->numSamples > 10000) {
			pixels_ss = 0;
		}
		else {
			/* zero arrays */
			...
			else if (summary->toolType == MBSYS_HDCS_EM1000 || summary->toolType == MBSYS_HDCS_EM12_single ||
			         summary->toolType == MBSYS_HDCS_EM12_dual || summary->toolType == MBSYS_HDCS_EM121A ||
			         summary->toolType == MBSYS_HDCS_EM1002 || summary->toolType == MBSYS_HDCS_EM120 ||
			         summary->toolType == MBSYS_HDCS_SeaBat_8125 || summary->toolType == MBSYS_HDCS_SeaBat_8111 ||
			         summary->toolType == MBSYS_HDCS_SeaBat_8150 || summary->toolType == MBSYS_HDCS_EM3002 ||
			         summary->toolType == MBSYS_HDCS_EM710 || summary->toolType == MBSYS_HDCS_EM3002 ||
			         summary->toolType == MBSYS_HDCS_EM3002D || summary->toolType == MBSYS_HDCS_SeaBat_8160) {
				if (profile->power == 1)
					ss_spacing = 0.6;
			...
			for (i = 0; i < profile->numDepths; i++) {
				...
				if (beam->observedDepth != 0 && (beam->status == 0 || beam->status == 22)) {
					...
					else if ((beam->offset - offset_start) > sample_count)
			...
			for (k = first + 1; k < last; k++) {
				if (ss_cnt[k] <= 0) {
					...
					ss_alongtrack[k] =
					    ss_alongtrack[k1] + (ss_alongtrack[k2] - ss_alongtrack[k1]) * ((double)(k - k1)) / ((double)(k2 - k1));
				}
				else {
					k1 = k;
				}
	...
	if (status == MB_SUCCESS && store != NULL) {
		...
		if (dataplus->kind == MB_DATA_SUMMARY || dataplus->kind == MB_DATA_DATA) {
			/* summary values */
		...
		if (dataplus->kind == MB_DATA_DATA) {
			...
			/* raw sidescan */
			if (profile->numSamples > 0 && store->numSamples < profile->numSamples && store->ss_raw != NULL)
				status = mb_freed(verbose, __FILE__, __LINE__, (void **)&store->ss_raw, error);
			if (profile->numSamples > 0 && data->ss_raw != NULL && store->ss_raw == NULL) {
				status = mb_mallocd(verbose, __FILE__, __LINE__, profile->numSamples, (void **)&store->ss_raw, error);
			}
...
int mbr_wt_omghdcsj(int verbose, void *mbio_ptr, void *store_ptr, int *error) {
	...
	if (store != NULL) {
		...
		*image_size = store->image_size;
		...
		if (dataplus->kind == MB_DATA_DATA) {
			...
			/* sidescan */
			if (store->numSamples > 0 && profile->numSamples < store->numSamples && data->ss_raw != NULL)
				status = mb_freed(verbose, __FILE__, __LINE__, (void **)&data->ss_raw, error);
	...
	if (status == MB_SUCCESS && dataplus->kind == MB_DATA_SUMMARY) {
...
#ifdef BYTESWAPPED
		int_ptr = (int *)&buffer[offset];
		*int_ptr = mb_swap_int(summary->sensorNumber);
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = mb_swap_int(summary->subFileID);
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = mb_swap_int(summary->fileVersion);
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = mb_swap_int(summary->toolType);
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = mb_swap_int(summary->numProfiles);
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = mb_swap_int(summary->numDepths);
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = mb_swap_int(summary->timeScale);
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = mb_swap_int(summary->refTime);
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = mb_swap_int(summary->minTime);
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = mb_swap_int(summary->maxTime);
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = mb_swap_int(summary->positionType);
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = mb_swap_int(summary->positionScale);
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = mb_swap_int(summary->refLat);
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = mb_swap_int(summary->minLat);
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = mb_swap_int(summary->maxLat);
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = mb_swap_int(summary->refLong);
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = mb_swap_int(summary->minLong);
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = mb_swap_int(summary->maxLong);
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = mb_swap_int(summary->minObsDepth);
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = mb_swap_int(summary->maxObsDepth);
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = mb_swap_int(summary->minProcDepth);
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = mb_swap_int(summary->maxProcDepth);
		offset += 4;
		int_ptr = (int *)&buffer[offset];
...
#else
		int_ptr = (int *)&buffer[offset];
		*int_ptr = summary->sensorNumber;
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = summary->subFileID;
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = summary->fileVersion;
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = summary->toolType;
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = summary->numProfiles;
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = summary->numDepths;
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = summary->timeScale;
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = summary->refTime;
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = summary->minTime;
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = summary->maxTime;
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = summary->positionType;
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = summary->positionScale;
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = summary->refLat;
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = summary->minLat;
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = summary->maxLat;
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = summary->refLong;
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = summary->minLong;
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = summary->maxLong;
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = summary->minObsDepth;
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = summary->maxObsDepth;
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = summary->minProcDepth;
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		*int_ptr = summary->maxProcDepth;
		offset += 4;
		int_ptr = (int *)&buffer[offset];
		...
		*int_ptr = summary->totalBeamBytes;
		...
		if ((write_size = fwrite(buffer, 1, sum_size, mb_io_ptr->mbfp)) == sum_size) {
	...
	/* else reverse parse and write the data record */
		...
		if (*fileVersion == 1) {
#ifdef BYTESWAPPED
			int_ptr = (int *)&buffer[offset];
			*int_ptr = mb_swap_int(profile->status);
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			*int_ptr = mb_swap_int(profile->numDepths);
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			*int_ptr = mb_swap_int(profile->timeOffset);
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			*int_ptr = mb_swap_int(profile->vesselLatOffset);
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			*int_ptr = mb_swap_int(profile->vesselLongOffset);
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			*int_ptr = mb_swap_int(profile->vesselHeading);
			offset += 4;
			if (offset < *profile_size) {
				int_ptr = (int *)&buffer[offset];
				*int_ptr = mb_swap_int(profile->vesselHeave);
				offset += 4;
				int_ptr = (int *)&buffer[offset];
				*int_ptr = mb_swap_int(profile->vesselPitch);
				offset += 4;
				int_ptr = (int *)&buffer[offset];
				*int_ptr = mb_swap_int(profile->vesselRoll);
				offset += 4;
				int_ptr = (int *)&buffer[offset];
				*int_ptr = mb_swap_int(profile->tide);
				offset += 4;
				int_ptr = (int *)&buffer[offset];
				*int_ptr = mb_swap_int(profile->vesselVelocity);
				offset += 4;
			}
			if (offset < *profile_size) {
				buffer[offset] = profile->power;
				offset += 1;
				buffer[offset] = profile->TVG;
				offset += 1;
				buffer[offset] = profile->attenuation;
				offset += 1;
				buffer[offset] = profile->edflag;
				offset += 1;
				int_ptr = (int *)&buffer[offset];
				*int_ptr = mb_swap_int(profile->soundVelocity);
				offset += 4;
				int_ptr = (int *)&buffer[offset];
				*int_ptr = mb_swap_int(profile->lengthImageDataField);
				offset += 4;
				int_ptr = (int *)&buffer[offset];
				*int_ptr = mb_swap_int(profile->pingNo);
				offset += 4;
				buffer[offset] = profile->mode;
				offset += 1;
				buffer[offset] = profile->Q_factor;
				offset += 1;
				buffer[offset] = profile->pulseLength;
				offset += 1;
				buffer[offset] = profile->unassigned;
				offset += 1;
			}
#else
			int_ptr = (int *)&buffer[offset];
			*int_ptr = profile->status;
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			*int_ptr = profile->numDepths;
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			*int_ptr = profile->timeOffset;
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			*int_ptr = profile->vesselLatOffset;
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			*int_ptr = profile->vesselLongOffset;
			offset += 4;
			int_ptr = (int *)&buffer[offset];
			*int_ptr = profile->vesselHeading;
			offset += 4;
			if (offset < *profile_size) {
				int_ptr = (int *)&buffer[offset];
				*int_ptr = profile->vesselHeave;
				offset += 4;
				int_ptr = (int *)&buffer[offset];
				*int_ptr = profile->vesselPitch;
				offset += 4;
				int_ptr = (int *)&buffer[offset];
				*int_ptr = profile->vesselRoll;
				offset += 4;
				int_ptr = (int *)&buffer[offset];
				*int_ptr = profile->tide;
				offset += 4;
				int_ptr = (int *)&buffer[offset];
				*int_ptr = profile->vesselVelocity;
				offset += 4;
			}
			if (offset < *profile_size) {
				buffer[offset] = profile->power;
				...
				offset += 1;
				int_ptr = (int *)&buffer[offset];
				*int_ptr = profile->soundVelocity;
				offset += 4;
				int_ptr = (int *)&buffer[offset];
				*int_ptr = profile->lengthImageDataField;
				offset += 4;
				int_ptr = (int *)&buffer[offset];
				*int_ptr = profile->pingNo;
				offset += 4;
				buffer[offset] = profile->mode;
				offset += 1;
				buffer[offset] = profile->Q_factor;
			...
			*int_ptr = mb_swap_int(profile->vesselLongOffset);
			offset += 4;
			short_ptr = (short *)&buffer[offset];
			*short_ptr = (short)mb_swap_short((short)(profile->vesselHeading / 10000));
			offset += 2;
			short_ptr = (short *)&buffer[offset];
			*short_ptr = (short)mb_swap_short((short)(profile->vesselHeave));
			offset += 2;
			short_ptr = (short *)&buffer[offset];
			*short_ptr = (short)mb_swap_short((short)(profile->vesselPitch / 1000));
			offset += 2;
			short_ptr = (short *)&buffer[offset];
			*short_ptr = (short)mb_swap_short((short)(profile->vesselRoll / 1000));
			offset += 2;
			short_ptr = (short *)&buffer[offset];
			*short_ptr = (short)mb_swap_short((short)(profile->tide));
			offset += 2;
			short_ptr = (short *)&buffer[offset];
			*short_ptr = (short)mb_swap_short((short)(profile->numDepths));
			offset += 2;
			buffer[offset] = profile->power;
			offset += 1;
			buffer[offset] = profile->TVG;
			...
			*int_ptr = profile->vesselLongOffset;
			offset += 4;
			short_ptr = (short *)&buffer[offset];
			*short_ptr = (short)(profile->vesselHeading / 10000);
			offset += 2;
			short_ptr = (short *)&buffer[offset];
			*short_ptr = (short)(profile->vesselHeave);
			offset += 2;
			short_ptr = (short *)&buffer[offset];
			*short_ptr = (short)(profile->vesselPitch / 1000);
			offset += 2;
			short_ptr = (short *)&buffer[offset];
			*short_ptr = (short)(profile->vesselRoll / 1000);
			offset += 2;
			short_ptr = (short *)&buffer[offset];
			*short_ptr = (short)(profile->tide);
			offset += 2;
			short_ptr = (short *)&buffer[offset];
			*short_ptr = (short)(profile->numDepths);
			offset += 2;
			buffer[offset] = profile->power;
			offset += 1;
			buffer[offset] = profile->TVG;
			...
			*short_ptr = (short)mb_swap_short((short)(profile->numDepths));
			...
			if (offset < *profile_size) {
				short_ptr = (short *)&buffer[offset];
				*short_ptr = (short)mb_swap_short((short)(profile->td_sound_speed));
				offset += 2;
				short_ptr = (short *)&buffer[offset];
				*short_ptr = (short)mb_swap_short((short)(profile->samp_rate));
				offset += 2;
				buffer[offset] = profile->z_res_cm;
				offset += 1;
				buffer[offset] = profile->xy_res_cm;
				offset += 1;
				buffer[offset] = profile->ssp_source;
				offset += 1;
				buffer[offset] = profile->filter_ID;
				offset += 1;
				short_ptr = (short *)&buffer[offset];
				*short_ptr = (short)mb_swap_short((short)(profile->absorp_coeff));
				offset += 2;
				short_ptr = (short *)&buffer[offset];
				*short_ptr = (short)mb_swap_short((short)(profile->tx_pulse_len));
				offset += 2;
				short_ptr = (short *)&buffer[offset];
				*short_ptr = (short)mb_swap_short((short)(profile->tx_beam_width));
				offset += 2;
				short_ptr = (short *)&buffer[offset];
				*short_ptr = (short)mb_swap_short((short)(profile->max_swath_width));
				offset += 2;
				buffer[offset] = profile->tx_power_reduction;
				offset += 1;
				buffer[offset] = profile->rx_beam_width;
				offset += 1;
				buffer[offset] = profile->rx_bandwidth;
				offset += 1;
				buffer[offset] = profile->rx_gain_reduction;
				offset += 1;
				buffer[offset] = profile->tvg_crossover;
				offset += 1;
				buffer[offset] = profile->beam_spacing;
				offset += 1;
				buffer[offset] = profile->coverage_sector;
				offset += 1;
				buffer[offset] = profile->yaw_stab_mode;
				offset += 1;
			}
#else
			int_ptr = (int *)&buffer[offset];
			...
			*short_ptr = (short)(profile->numDepths);
			...
			if (offset < *profile_size) {
				short_ptr = (short *)&buffer[offset];
				*short_ptr = (short)(profile->td_sound_speed);
				offset += 2;
				short_ptr = (short *)&buffer[offset];
				*short_ptr = (short)(profile->samp_rate);
				offset += 2;
				buffer[offset] = profile->z_res_cm;
				offset += 1;
				buffer[offset] = profile->xy_res_cm;
				...
				offset += 1;
				short_ptr = (short *)&buffer[offset];
				*short_ptr = (short)(profile->absorp_coeff);
				offset += 2;
				short_ptr = (short *)&buffer[offset];
				*short_ptr = (short)(profile->tx_pulse_len);
				offset += 2;
				short_ptr = (short *)&buffer[offset];
				*short_ptr = (short)(profile->tx_beam_width);
				offset += 2;
				short_ptr = (short *)&buffer[offset];
				*short_ptr = (short)(profile->max_swath_width);
				offset += 2;
				buffer[offset] = profile->tx_power_reduction;
				offset += 1;
				buffer[offset] = profile->rx_beam_width;
			...
			if (summary->Profile_BitsDefining[0]) {
				...
				if (summary->Profile_BitsDefining[0] & PROF_ui_vesselHeading) {
					short_ptr = (short *)&buffer[offset];
					*short_ptr = (short)mb_swap_short((short)(profile->vesselHeading / 1000));
					offset += 2;
				}
				if (summary->Profile_BitsDefining[0] & PROF_si_vesselHeave) {
					short_ptr = (short *)&buffer[offset];
			...
			if (summary->Profile_BitsDefining[1]) {
				...
				if (summary->Profile_BitsDefining[1] & PROF_ui_soundVelocity) {
					short_ptr = (short *)&buffer[offset];
					*short_ptr = (short)mb_swap_short((short)profile->soundVelocity);
					offset += 2;
				}
				if (summary->Profile_BitsDefining[1] & PROF_ui_lengthImageDataField) {
					short_ptr = (short *)&buffer[offset];
					*short_ptr = (short)mb_swap_short((short)profile->lengthImageDataField);
					offset += 2;
				}
				if (summary->Profile_BitsDefining[1] & PROF_ui_pingNo) {
					short_ptr = (short *)&buffer[offset];
					*short_ptr = (short)mb_swap_short((short)profile->pingNo);
					offset += 2;
				}
				if (summary->Profile_BitsDefining[1] & PROF_uc_mode) {
					buffer[offset] = profile->mode;
			...
			if (summary->Profile_BitsDefining[3]) {
				if (summary->Profile_BitsDefining[3] & PROF_ss_longperiod_heaveCorrection) {
					short_ptr = (short *)&buffer[offset];
					*short_ptr = (short)mb_swap_short((short)profile->longperiod_heaveCorrection);
					offset += 2;
				}
				if (summary->Profile_BitsDefining[3] & PROF_ss_dynamic_draftCorrection) {
					short_ptr = (short *)&buffer[offset];
			...
			if (summary->Profile_BitsDefining[0]) {
				...
				if (summary->Profile_BitsDefining[0] & PROF_ui_vesselHeading) {
					short_ptr = (short *)&buffer[offset];
					*short_ptr = profile->vesselHeading / 1000;
					offset += 2;
				}
				if (summary->Profile_BitsDefining[0] & PROF_si_vesselHeave) {
					short_ptr = (short *)&buffer[offset];
					*short_ptr = profile->vesselHeave;
					offset += 2;
				}
				if (summary->Profile_BitsDefining[0] & PROF_si_vesselPitch) {
					short_ptr = (short *)&buffer[offset];
					*short_ptr = profile->vesselPitch / 1000;
					offset += 2;
				}
				if (summary->Profile_BitsDefining[0] & PROF_si_vesselRoll) {
					short_ptr = (short *)&buffer[offset];
					*short_ptr = profile->vesselRoll / 1000;
					offset += 2;
				}
				if (summary->Profile_BitsDefining[0] & PROF_si_tide) {
					int_ptr = (int *)&buffer[offset];
			...
			if (summary->Profile_BitsDefining[1]) {
				...
				if (summary->Profile_BitsDefining[1] & PROF_ui_soundVelocity) {
					short_ptr = (short *)&buffer[offset];
					*short_ptr = profile->soundVelocity;
					offset += 2;
				}
				if (summary->Profile_BitsDefining[1] & PROF_ui_lengthImageDataField) {
					short_ptr = (short *)&buffer[offset];
					*short_ptr = profile->lengthImageDataField;
					offset += 2;
				}
				if (summary->Profile_BitsDefining[1] & PROF_ui_pingNo) {
					short_ptr = (short *)&buffer[offset];
					*short_ptr = profile->pingNo;
					offset += 2;
				}
				if (summary->Profile_BitsDefining[1] & PROF_uc_mode) {
					buffer[offset] = profile->mode;
			...
			if (summary->Profile_BitsDefining[3]) {
				if (summary->Profile_BitsDefining[3] & PROF_ss_longperiod_heaveCorrection) {
					short_ptr = (short *)&buffer[offset];
					*short_ptr = (short)profile->longperiod_heaveCorrection;
					offset += 2;
				}
				if (summary->Profile_BitsDefining[3] & PROF_ss_dynamic_draftCorrection) {
					short_ptr = (short *)&buffer[offset];
		...
		if ((write_size = fwrite(buffer, 1, *profile_size, mb_io_ptr->mbfp)) == *profile_size) {
			mb_io_ptr->file_bytes += write_size;
			status = MB_SUCCESS;
			*error = MB_ERROR_NO_ERROR;
		}
			...
			for (i = 0; i < profile->numDepths; i++) {
				...
				if (*fileVersion == 1) {
#ifdef BYTESWAPPED
					int_ptr = (int *)&buffer[offset];
					*int_ptr = mb_swap_int(beam->status);
					offset += 4;
					int_ptr = (int *)&buffer[offset];
					*int_ptr = mb_swap_int(beam->observedDepth);
					offset += 4;
					if ((offset - offset_start) < *beam_size) {
						int_ptr = (int *)&buffer[offset];
						*int_ptr = mb_swap_int(beam->acrossTrack);
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						*int_ptr = mb_swap_int(beam->alongTrack);
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						*int_ptr = mb_swap_int(beam->latOffset);
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						*int_ptr = mb_swap_int(beam->processedDepth);
						offset += 4;
					}
					if ((offset - offset_start) < *beam_size) {
						int_ptr = (int *)&buffer[offset];
						*int_ptr = mb_swap_int(beam->processedDepth);
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						*int_ptr = mb_swap_int(beam->timeOffset);
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						*int_ptr = mb_swap_int(beam->depthAccuracy);
						offset += 4;
					}
					if ((offset - offset_start) < *beam_size) {
						buffer[offset] = beam->reflectivity;
						offset += 1;
						buffer[offset] = beam->Q_factor;
						offset += 1;
						buffer[offset] = beam->beam_no;
						offset += 1;
						buffer[offset] = beam->freq;
						offset += 1;
						buffer[offset] = beam->calibratedBackscatter;
						offset += 1;
						buffer[offset] = beam->mindB;
						offset += 1;
						buffer[offset] = beam->maxdB;
						offset += 1;
						buffer[offset] = beam->pseudoAngleIndependentBackscatter;
						offset += 1;
					}
					if ((offset - offset_start) < *beam_size) {
						int_ptr = (int *)&buffer[offset];
						*int_ptr = mb_swap_int(beam->range);
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						*int_ptr = mb_swap_int(beam->no_samples);
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						*int_ptr = mb_swap_int(beam->offset);
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						*int_ptr = mb_swap_int(beam->centre_no);
						offset += 4;
						buffer[offset] = beam->sample_unit;
						offset += 1;
						buffer[offset] = beam->sample_interval;
						offset += 1;
						buffer[offset] = beam->dummy[0];
						offset += 1;
						buffer[offset] = beam->dummy[1];
						offset += 1;
					}
#else
					int_ptr = (int *)&buffer[offset];
					*int_ptr = beam->status;
					offset += 4;
					int_ptr = (int *)&buffer[offset];
					*int_ptr = beam->observedDepth;
					offset += 4;
					if ((offset - offset_start) < *beam_size) {
						int_ptr = (int *)&buffer[offset];
						*int_ptr = beam->acrossTrack;
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						*int_ptr = beam->alongTrack;
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						*int_ptr = beam->latOffset;
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						*int_ptr = beam->longOffset;
						offset += 4;
					}
					if ((offset - offset_start) < *beam_size) {
						int_ptr = (int *)&buffer[offset];
						*int_ptr = beam->processedDepth;
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						*int_ptr = beam->timeOffset;
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						*int_ptr = beam->depthAccuracy;
						offset += 4;
					}
					if ((offset - offset_start) < *beam_size) {
						buffer[offset] = beam->reflectivity;
					...
					if ((offset - offset_start) < *beam_size) {
						...
						*int_ptr = beam->range;
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						*int_ptr = beam->no_samples;
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						*int_ptr = beam->offset;
						offset += 4;
						int_ptr = (int *)&buffer[offset];
						*int_ptr = beam->centre_no;
						offset += 4;
						buffer[offset] = beam->sample_unit;
						offset += 1;
						buffer[offset] = beam->sample_interval;
					...
					MaxVal = MAX(abs(beam->observedDepth), abs((int)beam->acrossTrack));
					if (MaxVal < 30000)
						ScaleFactor = 1;
					...
					if ((offset - offset_start) < *beam_size) {
						short_ptr = (short *)&buffer[offset];
						*short_ptr = (short)mb_swap_short((short)(beam->range));
						offset += 2;
					}
					if ((offset - offset_start) < *beam_size) {
						int_ptr = (int *)&buffer[offset];
						*int_ptr = mb_swap_int(beam->offset);
						offset += 4;
						short_ptr = (short *)&buffer[offset];
						*short_ptr = (short)mb_swap_short((short)(beam->no_samples));
						offset += 2;
						short_ptr = (short *)&buffer[offset];
						*short_ptr = (short)mb_swap_short((short)(beam->centre_no));
						offset += 2;
					}
#else
					if ((offset - offset_start) < *beam_size) {
						...
						*short_ptr = (short)beam->observedDepth;
						offset += 2;
						short_ptr = (short *)&buffer[offset];
						*short_ptr = (short)beam->acrossTrack;
						offset += 2;
						buffer[offset] = beam->status;
						offset += 1;
					}
					...
					if ((offset - offset_start) < *beam_size) {
						...
						*int_ptr = beam->offset;
						offset += 4;
						short_ptr = (short *)&buffer[offset];
						*short_ptr = (short)beam->no_samples;
						offset += 2;
						short_ptr = (short *)&buffer[offset];
						*short_ptr = (short)beam->centre_no;
						offset += 2;
					}
#endif
				}
				else if (*fileVersion == 3) {
					MaxVal = MAX(abs(beam->observedDepth), abs(beam->acrossTrack));
					if (MaxVal < 32000) {
					...
					if ((offset - offset_start) < *beam_size) {
						short_ptr = (short *)&buffer[offset];
						*short_ptr = (short)mb_swap_short((short)(beam->beam_depress_angle));
						offset += 2;
						short_ptr = (short *)&buffer[offset];
						*short_ptr = (short)mb_swap_short((short)(beam->beam_heading_angle));
						offset += 2;
						buffer[offset] = beam->samp_win_length;
						offset += 1;
						buffer[offset] = scaling_factor;
						offset += 1;
						buffer[offset] = beam->Q_factor;
						offset += 1;
						buffer[offset] = 0;
					...
					if ((offset - offset_start) < *beam_size) {
						short_ptr = (short *)&buffer[offset];
						*short_ptr = (short)beam->beam_depress_angle;
						offset += 2;
						short_ptr = (short *)&buffer[offset];
						*short_ptr = (short)beam->beam_heading_angle;
						offset += 2;
						buffer[offset] = beam->samp_win_length;
						offset += 1;
						buffer[offset] = scaling_factor;
				...
				/* V4 */
					...
					if (summary->Beam_BitsDefining[0]) {
						...
						if (summary->Beam_BitsDefining[0] & BEAM_uc_scaling_factor) {
							buffer[offset] = beam->scaling_factor;
							offset += 1;
						}
						...
						if (summary->Beam_BitsDefining[0] & BEAM_si_longOffset) {
							int_ptr = (int *)&buffer[offset];
							*int_ptr = mb_swap_int(beam->longOffset);
							offset += 4;
						}
						if (summary->Beam_BitsDefining[0] & BEAM_si_processedDepth) {
							short_ptr = (short *)&buffer[offset];
					...
					if (summary->Beam_BitsDefining[3]) {
						...
						if (summary->Beam_BitsDefining[3] & BEAM_us_other_range) {
							short_ptr = (short *)&buffer[offset];
							*short_ptr = (short)mb_swap_short((short)beam->other_range);
							offset += 2;
						}
						if (summary->Beam_BitsDefining[3] & BEAM_ss_Tx_steer) {
							short_ptr = (short *)&buffer[offset];
							*short_ptr = (short)mb_swap_short((short)beam->Tx_steer);
							offset += 2;
						}
						if (summary->Beam_BitsDefining[3] & BEAM_ss_Rc_steer) {
							short_ptr = (short *)&buffer[offset];
							*short_ptr = (short)mb_swap_short((short)beam->Rc_steer);
							offset += 2;
						}
						if (summary->Beam_BitsDefining[3] & BEAM_uc_TxSector) {
							buffer[offset] = beam->TxSector;
							offset += 1;
						}
						if (summary->Beam_BitsDefining[3] & BEAM_f_Ifremer_qfactor) {
							float_ptr = (float *)&buffer[offset];
					...
					if (summary->Beam_BitsDefining[4]) {
						if (summary->Beam_BitsDefining[4] & BEAM_ui_timestampOffset) {
							int_ptr = (int *)&buffer[offset];
							*int_ptr = mb_swap_int(beam->timestampOffset);
							offset += 4;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_us_no_RAMAN) {
							short_ptr = (short *)&buffer[offset];
							*short_ptr = (short)mb_swap_short((short)beam->no_RAMAN);
							offset += 2;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_us_no_IR) {
							short_ptr = (short *)&buffer[offset];
							*short_ptr = (short)mb_swap_short((short)beam->no_IR);
							offset += 2;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_us_no_GAPD) {
							short_ptr = (short *)&buffer[offset];
							*short_ptr = (short)mb_swap_short((short)beam->no_GAPD);
							offset += 2;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_us_no_PMT) {
							short_ptr = (short *)&buffer[offset];
							*short_ptr = (short)mb_swap_short((short)beam->no_PMT);
							offset += 2;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_uc_prim_depth_conf) {
							buffer[offset] = beam->prim_depth_conf;
							offset += 1;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_uc_seco_depth_conf) {
							buffer[offset] = beam->seco_depth_conf;
							offset += 1;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_ss_scan_azimuth) {
							short_ptr = (short *)&buffer[offset];
							*short_ptr = (short)mb_swap_short((short)beam->scan_azimuth);
							offset += 2;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_us_nadir_angle) {
							short_ptr = (short *)&buffer[offset];
							*short_ptr = (short)mb_swap_short((short)beam->nadir_angle);
							offset += 2;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_si_secondaryDepth) {
							short_ptr = (short *)&buffer[offset];
							*short_ptr = (short)mb_swap_short((short)beam->secondaryDepth);
							offset += 2;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_ss_wave_height) {
							short_ptr = (short *)&buffer[offset];
							*short_ptr = (short)mb_swap_short((short)beam->wave_height);
							offset += 2;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_si_opaqueDepth_PMT) {
							int_ptr = (int *)&buffer[offset];
							*int_ptr = mb_swap_int(beam->opaqueDepth_PMT);
							offset += 4;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_si_extinctionDepth_PMT) {
							int_ptr = (int *)&buffer[offset];
							*int_ptr = mb_swap_int(beam->extinctionDepth_PMT);
							offset += 4;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_si_pimDepth_PMT) {
							int_ptr = (int *)&buffer[offset];
							*int_ptr = mb_swap_int(beam->pimDepth_PMT);
							offset += 4;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_si_opaqueDepth_GAPD) {
							int_ptr = (int *)&buffer[offset];
							*int_ptr = mb_swap_int(beam->opaqueDepth_GAPD);
							offset += 4;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_si_extinctionDepth_GAPD) {
							int_ptr = (int *)&buffer[offset];
							*int_ptr = mb_swap_int(beam->extinctionDepth_GAPD);
							offset += 4;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_si_pimDepth_GAPD) {
							int_ptr = (int *)&buffer[offset];
							*int_ptr = mb_swap_int(beam->pimDepth_GAPD);
							offset += 4;
						}
					}
					...
					if (summary->Beam_BitsDefining[5]) {
						...
						if (summary->Beam_BitsDefining[5] & BEAM_ui_snippet_first_sample) {
							int_ptr = (int *)&buffer[offset];
							*int_ptr = mb_swap_int(beam->snippet_first_sample);
							offset += 4;
						}
						if (summary->Beam_BitsDefining[5] & BEAM_ui_snippet_last_sample) {
							int_ptr = (int *)&buffer[offset];
							*int_ptr = mb_swap_int(beam->snippet_last_sample);
							offset += 4;
						}
						if (summary->Beam_BitsDefining[5] & BEAM_f_intensity) {
							float_ptr = (float *)&buffer[offset];
							mb_swap_float(float_ptr);
							*float_ptr = beam->intensity;
							offset += 4;
						}
					}
					...
					if (summary->Beam_BitsDefining[3]) {
						...
						if (summary->Beam_BitsDefining[3] & BEAM_us_other_range) {
							short_ptr = (short *)&buffer[offset];
							*short_ptr = (short)beam->other_range;
							offset += 2;
						}
						if (summary->Beam_BitsDefining[3] & BEAM_ss_Tx_steer) {
							short_ptr = (short *)&buffer[offset];
							*short_ptr = (short)beam->Tx_steer;
							offset += 2;
						}
						if (summary->Beam_BitsDefining[3] & BEAM_ss_Rc_steer) {
							short_ptr = (short *)&buffer[offset];
							*short_ptr = (short)beam->Rc_steer;
							offset += 2;
						}
						if (summary->Beam_BitsDefining[3] & BEAM_uc_TxSector) {
							buffer[offset] = beam->TxSector;
					...
					if (summary->Beam_BitsDefining[4]) {
						if (summary->Beam_BitsDefining[4] & BEAM_ui_timestampOffset) {
							int_ptr = (int *)&buffer[offset];
							*int_ptr = beam->timestampOffset;
							offset += 4;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_us_no_RAMAN) {
							short_ptr = (short *)&buffer[offset];
							*short_ptr = (short)beam->no_RAMAN;
							offset += 2;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_us_no_IR) {
							short_ptr = (short *)&buffer[offset];
							*short_ptr = (short)beam->no_IR;
							offset += 2;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_us_no_GAPD) {
							short_ptr = (short *)&buffer[offset];
							*short_ptr = (short)beam->no_GAPD;
							offset += 2;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_us_no_PMT) {
							short_ptr = (short *)&buffer[offset];
							*short_ptr = (short)beam->no_PMT;
							offset += 2;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_uc_prim_depth_conf) {
							buffer[offset] = beam->prim_depth_conf;
						...
						if (summary->Beam_BitsDefining[4] & BEAM_ss_scan_azimuth) {
							short_ptr = (short *)&buffer[offset];
							*short_ptr = (short)beam->scan_azimuth;
							offset += 2;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_us_nadir_angle) {
							short_ptr = (short *)&buffer[offset];
							*short_ptr = (short)beam->nadir_angle;
							offset += 2;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_si_secondaryDepth) {
							short_ptr = (short *)&buffer[offset];
							*short_ptr = (short)beam->secondaryDepth;
							offset += 2;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_ss_wave_height) {
							short_ptr = (short *)&buffer[offset];
							*short_ptr = (short)beam->wave_height;
							offset += 2;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_si_opaqueDepth_PMT) {
							int_ptr = (int *)&buffer[offset];
							*int_ptr = beam->opaqueDepth_PMT;
							offset += 4;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_si_extinctionDepth_PMT) {
							int_ptr = (int *)&buffer[offset];
							*int_ptr = beam->extinctionDepth_PMT;
							offset += 4;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_si_pimDepth_PMT) {
							int_ptr = (int *)&buffer[offset];
							*int_ptr = beam->pimDepth_PMT;
							offset += 4;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_si_opaqueDepth_GAPD) {
							int_ptr = (int *)&buffer[offset];
							*int_ptr = beam->opaqueDepth_GAPD;
							offset += 4;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_si_extinctionDepth_GAPD) {
							int_ptr = (int *)&buffer[offset];
							*int_ptr = beam->extinctionDepth_GAPD;
							offset += 4;
						}
						if (summary->Beam_BitsDefining[4] & BEAM_si_pimDepth_GAPD) {
							int_ptr = (int *)&buffer[offset];
							*int_ptr = beam->pimDepth_GAPD;
							offset += 4;
						}
					}
					...
					if (summary->Beam_BitsDefining[5]) {
						...
						if (summary->Beam_BitsDefining[5] & BEAM_ui_snippet_first_sample) {
							int_ptr = (int *)&buffer[offset];
							*int_ptr = beam->snippet_first_sample;
							offset += 4;
						}
						if (summary->Beam_BitsDefining[5] & BEAM_ui_snippet_last_sample) {
							int_ptr = (int *)&buffer[offset];
							*int_ptr = beam->snippet_last_sample;
							offset += 4;
						}
						if (summary->Beam_BitsDefining[5] & BEAM_f_intensity) {
							float_ptr = (float *)&buffer[offset];
		...
		if ((write_size = fwrite(buffer, 1, *data_size, mb_io_ptr->mbfp)) == *data_size) {
			mb_io_ptr->file_bytes += write_size;
			status = MB_SUCCESS;
			*error = MB_ERROR_NO_ERROR;
		}
		...
		if (status == MB_SUCCESS && mb_io_ptr->mbfp2 != NULL &&
			...
			/* write the sidescan */
			if (status == MB_SUCCESS) {
				if ((write_size = fwrite(data->ss_raw, 1, profile->numSamples, mb_io_ptr->mbfp2)) == profile->numSamples) {
	...
	/* else write the comment */
		...
		if ((write_size = fwrite(buffer, 1, 4, mb_io_ptr->mbfp)) == 4) {
			mb_io_ptr->file_bytes += write_size;
			if ((write_size = fwrite(dataplus->comment, 1, MBF_OMGHDCSJ_MAX_COMMENT, mb_io_ptr->mbfp)) ==
