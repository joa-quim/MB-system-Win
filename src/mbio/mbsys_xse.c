 ...
 *	$Id: mbsys_xse.c 2291 2017-01-12 09:20:59Z caress $
 *
...
static char rcs_id[]="$Id: mbsys_xse.c 2291 2017-01-12 09:20:59Z caress $";
			...
			int *error)
{
	...
	status = mb_mallocd(verbose, __FILE__, __LINE__, sizeof(struct mbsys_xse_struct),
				store_ptr,error);
