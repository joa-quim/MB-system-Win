 ...
 *    $Id: mb_format.h 2308 2017-06-04 19:55:48Z caress $
 *
...
#define MB_FORMAT_UPDATEDATE "$Id: mb_format.h 2308 2017-06-04 19:55:48Z caress $ $Revision: $"
...
#define MBF_NONE 0
#define MBF_SBSIOMRG                                                                                                             \
	11 /* SeaBeam, 16 beam, bathymetry,                                                                                          \
binary, uncentered, SIO. */
#define MBF_SBSIOCEN                                                                                                             \
	12 /* SeaBeam, 19 beam, bathymetry,                                                                                          \
binary, centered, SIO. */
#define MBF_SBSIOLSI                                                                                                             \
	13 /* SeaBeam, 19 beam, bathymetry,                                                                                          \
binary, centered, obsolete, SIO. */
#define MBF_SBURICEN                                                                                                             \
	14 /* SeaBeam, 19 beam, bathymetry,                                                                                          \
binary, centered, URI. */
#define MBF_SBURIVAX                                                                                                             \
	15 /* SeaBeam, 19 beam, bathymetry,                                                                                          \
binary, centered,                                                                                                                \
VAX byte order, URI. */
#define MBF_SBSIOSWB                                                                                                             \
	16 /* SeaBeam, 19 beam, bathymetry,                                                                                          \
binary, centered,                                                                                                                \
swath-bathy, SIO. */
#define MBF_SBIFREMR                                                                                                             \
	17 /* SeaBeam, 19 beam, bathymetry,                                                                                          \
ascii, centered,                                                                                                                 \
sounding-oriented, IFREMER. */
#define MBF_HSATLRAW                                                                                                             \
	21 /* Hydrosweep DS raw format, 59 beam,                                                                                     \
bathymetry and amplitude,                                                                                                        \
ascii, Atlas Electronik. */
#define MBF_HSLDEDMB                                                                                                             \
	22 /* Hydrosweep DS, 59 beam, bathymetry,                                                                                    \
binary, NRL. */
#define MBF_HSURICEN                                                                                                             \
	23 /* Hydrosweep DS, 59 beam, bathymetry,                                                                                    \
binary, URI. */
#define MBF_HSLDEOIH                                                                                                             \
	24 /* Hydrosweep DS in-house format, 59 beam,                                                                                \
bathymetry and amplitude,                                                                                                        \
binary, centered, L-DEO. */
#define MBF_HSURIVAX                                                                                                             \
	25 /* Hydrosweep DS, 59 beam, bathymetry,                                                                                    \
binary, VAX byte order, URI. */
#define MBF_HSUNKNWN                                                                                                             \
	26 /* Hydrosweep DS, 59 beam, bathymetry,                                                                                    \
bathymetry and amplitude,                                                                                                        \
ascii, unknown origin, SOPAC. */
#define MBF_SB2000RW                                                                                                             \
	31 /* SeaBeam 2000 vender format,                                                                                            \
151 beam bathymetry and amplitude,                                                                                               \
2000 pixel sidescan, ascii + binary,                                                                                             \
SeaBeam Instruments. */
#define MBF_SB2000SB                                                                                                             \
	32 /* SeaBeam 2000, 121 beam bathymetry,                                                                                     \
binary, swath-bathy, SIO. */
#define MBF_SB2000SS                                                                                                             \
	33 /* SeaBeam 2000, 1000 pixel sidescan,                                                                                     \
binary, swath-bathy, SIO. */
#define MBF_SB2100RW                                                                                                             \
	41 /* SeaBeam 2100 series vender format,                                                                                     \
151 beam bathymetry and amplitude,                                                                                               \
2000 pixel sidescan, ascii + binary,                                                                                             \
centered, SeaBeam Instruments */
#define MBF_SB2100B1                                                                                                             \
	42 /* SeaBeam 2100 series vendor format,                                                                                     \
151 beam bathymetry and amplitude,                                                                                               \
2000 pixel sidescan, binary, centered,                                                                                           \
SeaBeam Instruments and L-DEO */
#define MBF_SB2100B2                                                                                                             \
	43 /* SeaBeam 2100 series vendor format,                                                                                     \
151 beam bathymetry and amplitude,                                                                                               \
binary, centered,                                                                                                                \
SeaBeam Instruments and L-DEO */
#define MBF_EMOLDRAW                                                                                                             \
	51 /* Old Simrad vendor multibeam format,                                                                                    \
...
ascii + binary, Simrad. */
#define MBF_EM12IFRM                                                                                                             \
	53 /* Simrad EM12S/EM12D multibeam archive format,                                                                           \
81 beam bathymetry and                                                                                                           \
amplitude,                                                                                                                       \
binary, read-only, IFREMER */
#define MBF_EM12DARW                                                                                                             \
	54 /* Simrad EM12 RRS Darwin processed format,                                                                               \
81 beam, bathymetry and amplitude,                                                                                               \
binary, centered, Oxford University */
#define MBF_EM300RAW                                                                                                             \
	56 /* Simrad EM300/EM3000 multibeam vendor format,                                                                           \
up to 254 beam bathymetry and                                                                                                    \
amplitude, variable pixel sidescan,                                                                                              \
ascii + binary, Simrad */
#define MBF_EM300MBA                                                                                                             \
	57 /* Simrad EM300/EM3000 multibeam processing format,                                                                       \
up to 254 beam bathymetry and                                                                                                    \
amplitude, variable pixel sidescan,                                                                                              \
ascii + binary, MBARI */
#define MBF_EM710RAW                                                                                                             \
	58 /* Kongsberg EM122, EM302, EM710 multibeam vendor format,                                                                 \
up to 400 beam bathymetry and                                                                                                    \
amplitude, variable pixel sidescan,                                                                                              \
binary, Kongsberg */
#define MBF_EM710MBA                                                                                                             \
	59 /* Kongsberg EM122, EM302, EM710 multibeam processing format,                                                             \
up to 400 beam bathymetry and                                                                                                    \
amplitude, variable pixel sidescan,                                                                                              \
binary, MBARI */
#define MBF_MR1PRHIG                                                                                                             \
	61 /* Obsolete MR1 post processed format,                                                                                    \
variable beam bathymetry, variable                                                                                               \
pixel sidescan, xdr binary, SOEST */
#define MBF_MR1ALDEO                                                                                                             \
	62 /* MR1 Lamont format with travel times,                                                                                   \
variable beam bathymetry, variable                                                                                               \
pixel sidescan, xdr binary, L-DEO */
#define MBF_MR1BLDEO                                                                                                             \
	63 /* MR1 small Lamont format with travel times,                                                                             \
variable beam bathymetry, variable                                                                                               \
pixel sidescan, xdr binary, L-DEO */
#define MBF_MR1PRVR2                                                                                                             \
	64 /* MR1 post processed format,                                                                                             \
variable beam bathymetry, variable                                                                                               \
pixel sidescan, xdr binary, SOEST */
#define MBF_MBLDEOIH                                                                                                             \
	71 /* Generic in-house multibeam, variable beam,                                                                             \
bathymetry, amplitude, and sidescan                                                                                              \
binary, centered, L-DEO. */
#define MBF_MBNETCDF                                                                                                             \
	75 /* CARAIBES CDF multibeam, variable beam,                                                                                 \
netCDF, IFREMER. */
#define MBF_MBNCDFXT                                                                                                             \
	76 /* CARAIBES CDF multibeam, variable beam,                                                                                 \
netCDF, IFREMER. - extended format */
#define MBF_CBAT9001                                                                                                             \
	81 /* Reson SeaBat 9001 multibeam, 60 beams                                                                                  \
bathymetry and amplitude,                                                                                                        \
binary, University of New Brunswick. */
#define MBF_CBAT8101                                                                                                             \
	82 /* Reson SeaBat 8101 multibeam, 101 beams                                                                                 \
bathymetry and amplitude,                                                                                                        \
binary, SeaBeam Instruments. */
#define MBF_HYPC8101                                                                                                             \
	83 /* Reson SeaBat 8101 multibeam, 101 beams                                                                                 \
bathymetry,                                                                                                                      \
ASCII, read-only,                                                                                                                \
Coastal Oceanographics. */
#define MBF_XTFR8101                                                                                                             \
	84 /* Reson SeaBat 8XXX multibeam, 250 beams                                                                                 \
bathymetry,                                                                                                                      \
binary, read-only,                                                                                                               \
Triton-Elics XTF format. */
#define MBF_RESONS8K                                                                                                             \
	85 /* Reson SeaBat 8XXX multibeam, 250 beams                                                                                 \
bathymetry,                                                                                                                      \
binary, read-only,                                                                                                               \
Reson 6042 format. */
#define MBF_SBATPROC                                                                                                             \
	86 /* Reson SeaBat 8XXX multibeam, 250 beams                                                                                 \
bathymetry,                                                                                                                      \
binary,                                                                                                                          \
MBARI processing format. */
#define MBF_RESON7KR                                                                                                             \
	88 /* Reson 7K multibeam vendor format                                                                                       \
...
#define MBF_RESON7KP                                                                                                             \
	89 /* MBARI processing format for Reson 7K multibeam data                                                                    \
Reson 7K series multibeam sonars,                                                                                                \
bathymetry, amplitude, three channels sidescan, and subbottom                                                                    \
up to 254 beams, variable pixels, binary, Reson. */
#define MBF_BCHRTUNB                                                                                                             \
	91 /* Elac BottomChart multibeam, 56 beams                                                                                   \
bathymetry and amplitude,                                                                                                        \
binary, University of New Brunswick. */
#define MBF_ELMK2UNB                                                                                                             \
	92 /* Elac BottomChart multibeam, 56 beams                                                                                   \
bathymetry and amplitude,                                                                                                        \
binary, University of New Brunswick. */
#define MBF_BCHRXUNB                                                                                                             \
	93 /* Elac BottomChart multibeam, 56 beams                                                                                   \
bathymetry and amplitude,                                                                                                        \
binary, University of New Brunswick. */
#define MBF_L3XSERAW                                                                                                             \
	94 /* ELAC/SeaBeam XSE vendor format                                                                                         \
...
#define MBF_HSDS2RAW                                                                                                             \
	182 /* STN Atlas raw multibeam format,                                                                                       \
Hydrosweep DS2, Hydrosweep MD,                                                                                                   \
Fansweep 10, Fansweep 20,                                                                                                        \
bathymetry, amplitude, and sidescan,                                                                                             \
up to 1440 beams and 4096 pixels,                                                                                                \
XDR binary, STN Atlas. */
#define MBF_HSDS2LAM                                                                                                             \
	183 /* L-DEO HSDS2 processing format,                                                                                        \
...
XDR binary, L-DEO. */
#define MBF_IMAGE83P                                                                                                             \
	191 /* Imagenex 83p vendor format for DeltaT multibeam                                                                       \
480 beams bathymetry */
#define MBF_IMAGEMBA                                                                                                             \
	192 /* MBARI processing format for DeltaT multibeam                                                                          \
480 beams bathymetry */
#define MBF_HYSWEEP1                                                                                                             \
	201 /* HYSWEEP format for multibeam data                                                                                     \
variable beams,  bathymetry, amplitude, and sidescan,                                                                            \
ascii text, single files, Hypack. */
#define MBF_XTFB1624                                                                                                             \
	211 /* XTF format Benthos Sidescan SIS1624                                                                                   \
	                variable pixels, dual frequency sidescan and subbottom,                                                      \
	                xtf variant, single files,                                                                                   \
	                low frequency sidescan returned as survey data, Benthos. */
#define MBF_SWPLSSXI                                                                                                             \
	221 /* SEA intermediate format for SWATHplus interferometric sonar,                                                          \
	                variable beams, bathymetry, amplitude,                                                                       \
	                binary, single files, SEA. */
#define MBF_SWPLSSXP                                                                                                             \
	222 /* SEA processed format for SWATHplus interferometric sonar,                                                             \
	                variable beams, bathymetry, amplitude,                                                                       \
	                binary, single files, SEA. */
#define MBF_3DDEPTHP                                                                                                             \
	231 /* 3DatDepth processed format for 3DatDepth LIDAR,                                                                       \
	            variable beams, bathymetry, amplitude,                                                                           \
	            binary, single files, 3DatDepth. */
#define MBF_WASSPENL                                                                                                             \
	241 /* WASSP Multibeam Vendor Format,                                                                                        \
	            WASSP multibeams,                                                                                                \
	            bathymetry and amplitude,                                                                                        \
	            122 or 244 beams, binary, Electronic Navigation Ltd. */
#define MBF_PHOTGRAM                                                                                                             \
	251 /* Stereo Photogrammetry format,                                                                                         \
	            stereo camera rigs,                                                                                              \
	            bathymetry,                                                                                                      \
