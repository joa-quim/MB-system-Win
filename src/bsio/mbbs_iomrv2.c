 ...
 *	$Id: mbbs_iomrv2.c 2308 2017-06-04 19:55:48Z caress $
 *
...
int mbbs_mr1_xdrpnghdrv2(Ping *png, XDR *xdrs)
/*
   Internal routine.
...
int mr1_xdrsidev2(PingSide *ps, XDR *xdrs, unsigned long *bytecnt)
/*
   Internal routine.
